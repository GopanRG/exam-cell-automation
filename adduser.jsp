    ...
    <body>
       ...
       <button onclick="goBack()" style=" position: absolute;right: 10%;left:90%;background-color:background;padding-left: 2em; padding-right: 2em;
        ...
        <div class="container-fluid">
                ...
                <form  action="ins_user.jsp" method="POST">
                   
                <div class="col-sm-4">
                    <label for="text" >User Name :</label>
                    
                    <input type="text" class="form-control " id="Username" Name="Username"
                           placeholder=" username " style="background-color: rgba(0,0,0,0.3); color: white;float:right"  required="required">
                </div>
                    <div class="col-sm-4">
                    <label for="text" >User id :</label>
                    
                    <input type="text" class="form-control " id="Userid" Name="Userid"
                           placeholder=" userid " style="background-color: rgba(0,0,0,0.3); color: white;float:right"  required="required">
                </div>
                    
                        <div class=" col-sm-4 ">
                    <label for="text" >Password:</label>
                    <input type="password" class="form-control" id="Password" Name="Password"
                           placeholder=" password" style="background-color: rgba(0,0,0,0.3); color: white;float: right" required="required">
                </div>
                      <div class=" col-sm-4 ">
                    ...
                    <input type="text" class="form-control" id="Privilege" Name="Privilege"
                           placeholder="privilege" style="background-color: rgba(0,0,0,0.3); color: white;float: right" required="required">
                </div>
                  </div>
