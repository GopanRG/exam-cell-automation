     ...
     for(int j=0;j<3;j++)
       {
        ...
        PdfPCell cell2 = new PdfPCell(new Paragraph(seat[0],font));
        ...
        PdfPCell cell3 = new PdfPCell(new Paragraph(seat[1],font));
        ...
        PdfPCell cell4 = new PdfPCell(new Paragraph(seat[2],font));
